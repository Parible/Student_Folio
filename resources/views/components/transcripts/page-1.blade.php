        ...
        <div class="flex flex-col mx-auto max-w-lg mb-10 -mt-24 p-2 md:-mt-2 md:w-1/2 border border-slate-800 shadow-lg rounded-md">
            ...
            <div class="mx-auto p-8">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <h2 class="text-base font-semibold leading-7 text-gray-900"><h1 class="text-2xl font-bold">Personal Information</h1></h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Complete application form clearly</p>
                  ...
                  <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                      ...
                      <div class="mt-2">
                        <input type="text" name="firstname" id="firstname" autocomplete="given-name" placeholder="Eg. Nyame" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-center">
                        @error('firstname')
                        <p class="bg-black text-red-500 text-xs mt-1">{{$message}}</p>
                    ...
                    <div class="sm:col-span-2">
                      <label for="ID" class="block text-sm font-medium leading-6 text-gray-900">Student</label>
                      <div class="mt-2">
                        <input type="text" name="ID" id="ID" autocomplete="ID" placeholder="Eg. 22112200** " class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-center">
                      </div>
                    </div>
                    ...
                    <a href="/page-2"><button class="mt-6 px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                      Next
                  </button></a>
                     </div>
                  </div>
